...
type CreateNoteAndUserRequest struct {
	Title    string `thrift:"title,1" form:"title" json:"title" query:"title" vd:"len($) > 0"`
	Content  string `thrift:"content,2" form:"content" json:"content" query:"content" vd:"len($) > 0"`
	Username string `thrift:"username,3" form:"username" json:"username" vd:"len($) > 0"`
	Password string `thrift:"password,4" form:"password" json:"password" vd:"len($) > 0"`
}

func NewCreateNoteAndUserRequest() *CreateNoteAndUserRequest {
	return &CreateNoteAndUserRequest{}
}

func (p *CreateNoteAndUserRequest) GetTitle() (v string) {
	return p.Title
}

func (p *CreateNoteAndUserRequest) GetContent() (v string) {
	return p.Content
}

func (p *CreateNoteAndUserRequest) GetUsername() (v string) {
	return p.Username
}

func (p *CreateNoteAndUserRequest) GetPassword() (v string) {
	return p.Password
}

var fieldIDToName_CreateNoteAndUserRequest = map[int16]string{
	1: "title",
	2: "content",
	3: "username",
	4: "password",
...
func (p *CreateNoteAndUserRequest) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_CreateNoteAndUserRequest[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *CreateNoteAndUserRequest) ReadField1(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadString(); err != nil {
		return err
	} else {
		p.Title = v
...
func (p *CreateNoteAndUserRequest) ReadField2(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadString(); err != nil {
		return err
	} else {
		p.Content = v
...
func (p *CreateNoteAndUserRequest) ReadField3(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadString(); err != nil {
		return err
	} else {
		p.Username = v
...
func (p *CreateNoteAndUserRequest) ReadField4(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadString(); err != nil {
		return err
	} else {
		p.Password = v
...
func (p *CreateNoteAndUserRequest) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("CreateNoteAndUserRequest"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *CreateNoteAndUserRequest) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("title", thrift.STRING, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteString(p.Title); err != nil {
...
func (p *CreateNoteAndUserRequest) writeField2(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("content", thrift.STRING, 2); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteString(p.Content); err != nil {
...
func (p *CreateNoteAndUserRequest) writeField3(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("username", thrift.STRING, 3); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteString(p.Username); err != nil {
...
func (p *CreateNoteAndUserRequest) writeField4(oprot thrift.TProtocol) (err error) {
...
func (p *CreateNoteAndUserRequest) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("CreateNoteAndUserRequest(%+v)", *p)
}

type CreateNoteAndUserResponse struct {
	BaseResp *BaseResp `thrift:"base_resp,1" form:"base_resp" json:"base_resp" query:"base_resp"`
}

func NewCreateNoteAndUserResponse() *CreateNoteAndUserResponse {
	return &CreateNoteAndUserResponse{}
}

var CreateNoteAndUserResponse_BaseResp_DEFAULT *BaseResp

func (p *CreateNoteAndUserResponse) GetBaseResp() (v *BaseResp) {
	if !p.IsSetBaseResp() {
		return CreateNoteAndUserResponse_BaseResp_DEFAULT
	}
	return p.BaseResp
}

var fieldIDToName_CreateNoteAndUserResponse = map[int16]string{
	1: "base_resp",
}

func (p *CreateNoteAndUserResponse) IsSetBaseResp() bool {
	return p.BaseResp != nil
}

func (p *CreateNoteAndUserResponse) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_CreateNoteAndUserResponse[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *CreateNoteAndUserResponse) ReadField1(iprot thrift.TProtocol) error {
	p.BaseResp = NewBaseResp()
	if err := p.BaseResp.Read(iprot); err != nil {
		return err
	}
...
func (p *CreateNoteAndUserResponse) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("CreateNoteAndUserResponse"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *CreateNoteAndUserResponse) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("base_resp", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.BaseResp.Write(oprot); err != nil {
...
func (p *CreateNoteAndUserResponse) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("CreateNoteAndUserResponse(%+v)", *p)
}
...
type ApiService interface {
	...
	CreateNoteAndUser(ctx context.Context, req *CreateNoteAndUserRequest) (r *CreateNoteAndUserResponse, err error)
}
...
func (p *ApiServiceClient) CreateNoteAndUser(ctx context.Context, req *CreateNoteAndUserRequest) (r *CreateNoteAndUserResponse, err error) {
	var _args ApiServiceCreateNoteAndUserArgs
	_args.Req = req
	var _result ApiServiceCreateNoteAndUserResult
	if err = p.Client_().Call(ctx, "CreateNoteAndUser", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
...
func NewApiServiceProcessor(handler ApiService) *ApiServiceProcessor {
	...
	self.AddToProcessorMap("CreateNoteAndUser", &apiServiceProcessorCreateNoteAndUser{handler: handler})
	return self
}
...
type apiServiceProcessorCreateNoteAndUser struct {
	handler ApiService
}

func (p *apiServiceProcessorCreateNoteAndUser) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := ApiServiceCreateNoteAndUserArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
		oprot.WriteMessageBegin("CreateNoteAndUser", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
		return false, err
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := ApiServiceCreateNoteAndUserResult{}
	var retval *CreateNoteAndUserResponse
	if retval, err2 = p.handler.CreateNoteAndUser(ctx, args.Req); err2 != nil {
		x := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing CreateNoteAndUser: "+err2.Error())
		oprot.WriteMessageBegin("CreateNoteAndUser", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
	...
	if err2 = oprot.WriteMessageBegin("CreateNoteAndUser", thrift.REPLY, seqId); err2 != nil {
		err = err2
	}
	if err2 = result.Write(oprot); err == nil && err2 != nil {
		err = err2
...
type ApiServiceCreateNoteAndUserArgs struct {
	Req *CreateNoteAndUserRequest `thrift:"req,1"`
}

func NewApiServiceCreateNoteAndUserArgs() *ApiServiceCreateNoteAndUserArgs {
	return &ApiServiceCreateNoteAndUserArgs{}
}

var ApiServiceCreateNoteAndUserArgs_Req_DEFAULT *CreateNoteAndUserRequest

func (p *ApiServiceCreateNoteAndUserArgs) GetReq() (v *CreateNoteAndUserRequest) {
	if !p.IsSetReq() {
		return ApiServiceCreateNoteAndUserArgs_Req_DEFAULT
	}
	return p.Req
}

var fieldIDToName_ApiServiceCreateNoteAndUserArgs = map[int16]string{
	1: "req",
}

func (p *ApiServiceCreateNoteAndUserArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *ApiServiceCreateNoteAndUserArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_ApiServiceCreateNoteAndUserArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *ApiServiceCreateNoteAndUserArgs) ReadField1(iprot thrift.TProtocol) error {
	p.Req = NewCreateNoteAndUserRequest()
	if err := p.Req.Read(iprot); err != nil {
		return err
	}
	return nil
...
func (p *ApiServiceCreateNoteAndUserArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("CreateNoteAndUser_args"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *ApiServiceCreateNoteAndUserArgs) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("req", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Req.Write(oprot); err != nil {
...
func (p *ApiServiceCreateNoteAndUserArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("ApiServiceCreateNoteAndUserArgs(%+v)", *p)
}

type ApiServiceCreateNoteAndUserResult struct {
	Success *CreateNoteAndUserResponse `thrift:"success,0,optional"`
}

func NewApiServiceCreateNoteAndUserResult() *ApiServiceCreateNoteAndUserResult {
	return &ApiServiceCreateNoteAndUserResult{}
}

var ApiServiceCreateNoteAndUserResult_Success_DEFAULT *CreateNoteAndUserResponse

func (p *ApiServiceCreateNoteAndUserResult) GetSuccess() (v *CreateNoteAndUserResponse) {
	if !p.IsSetSuccess() {
		return ApiServiceCreateNoteAndUserResult_Success_DEFAULT
	}
	return p.Success
}

var fieldIDToName_ApiServiceCreateNoteAndUserResult = map[int16]string{
	0: "success",
}

func (p *ApiServiceCreateNoteAndUserResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *ApiServiceCreateNoteAndUserResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_ApiServiceCreateNoteAndUserResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *ApiServiceCreateNoteAndUserResult) ReadField0(iprot thrift.TProtocol) error {
	p.Success = NewCreateNoteAndUserResponse()
	if err := p.Success.Read(iprot); err != nil {
		return err
	}
	return nil
...
func (p *ApiServiceCreateNoteAndUserResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("CreateNoteAndUser_result"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField0(oprot); err != nil {
...
func (p *ApiServiceCreateNoteAndUserResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err = oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *ApiServiceCreateNoteAndUserResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("ApiServiceCreateNoteAndUserResult(%+v)", *p)
}
